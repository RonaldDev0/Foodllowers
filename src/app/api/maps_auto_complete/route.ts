...
export async function POST (req: NextRequest) {
  ...
  // const places = await fetch(`https://maps.googleapis.com/maps/api/place/autocomplete/json?input=${encodeURIComponent(place)}&components=country:co&key=${process.env.NEXT_PUBLIC_GOOGLE_MAPS_API_KEY!}`).then(res => res.json())

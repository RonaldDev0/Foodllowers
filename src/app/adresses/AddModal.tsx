...
export default function AddModal ({ setOpen }: props) {
  return (
    <div className='w-full flex justify-center items-center h-screen fixed bg-[#d9d9d90e]'>
      <div className='w-[380px] p-10 bg-[#1F1F1F] rounded'>
        ...
        <form onSubmit={e => e.preventDefault()} className='flex flex-col gap-5 my-10'>
          ...
          <button className='bg-green-600 p-2 mt-5 rounded text-xl w-[300px]'>Add</button>
        </form>
      </div>
    </div>
  )
